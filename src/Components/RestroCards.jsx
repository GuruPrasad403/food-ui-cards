...
export default function RestroCards({img, name, rating, time, cuisine, location}) {
    return (
        <div className="col-span-1 bg-white flex flex-col justofy-around w-96  hover:transform hover:scale-90 transition rounded-xl">
            ...
            <div className="flex flex-col justify-around items-start p-4 gap-[1px]">
                ...
                <p className="text-gray-500 text-md">{cuisine}</p>
